...
//Destructuring
const notObject = document.querySelector("#");
const yesArray = document.querySelector("#");
const yesObject = document.querySelector("#");
const modernObject = document.querySelector("#");
...
const { name, surname, age } = student; // quando voglio modificare alcuni valori delle variabili senza modificare l'oggetto.
modernObjectObject.textContent = `${name},${surname},${age}`;
