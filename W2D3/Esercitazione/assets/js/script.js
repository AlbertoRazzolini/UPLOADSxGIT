...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  switch (personaggio.eye_color) {
    case "blue":
      perColoreOcchi.blue.push(personaggio);
      break;
    case "yellow":
      perColoreOcchi.yellow.push(personaggio);
      break;
    case "brown":
      perColoreOcchi.brown.push(personaggio);
      break;
    case "red":
      perColoreOcchi.red.push(personaggio);
      break;
    case "blue-gray":
      perColoreOcchi["blue-gray"].push(personaggio);
      break;
  }
}
console.log(perColoreOcchi);
